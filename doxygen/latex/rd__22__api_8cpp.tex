...
Setup and callback for the API on the root node.  
...
\begin{DoxyCompactList}\small\item\em API server object. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Set up the REST API server we use for the messages from Home Assistant to the mesh network. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em JSON object with a size of 200 bytes. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
JSON object with a size of 200 bytes. 
