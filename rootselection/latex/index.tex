...
If the root loses its connection to Home Assistant it will stop broadcasting. In this case, all the nodes that stop receiving these messages and will start selecting a new node.\hypertarget{index_autotoc_md15}{}\doxysubsubsection{Dependencies\+:}\label{index_autotoc_md15}
